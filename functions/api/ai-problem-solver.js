...
function extractFilters(message) {
  const text = normalize(message);
  const categories = [['logistik', /logistik|bongkar|muat|pindahan|gudang/], ['tukang', /tukang|bangunan|renovasi|cat|perbaikan/], ['kebersihan', /bersih|kebersihan|cleaning|sapu|pel/], ['serabutan', /serabutan|bantu|umum|tenaga kasar/]];
