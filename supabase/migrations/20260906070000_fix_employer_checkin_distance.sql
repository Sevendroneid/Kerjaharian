...
-- Fix employer check-in Haversine longitude delta.
-- The original function accidentally compared p_lng against v_lat,
-- which could reject valid check-ins or accept invalid locations.
